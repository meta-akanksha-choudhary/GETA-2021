...
function showTab(n) {
    ...
    if (n == 14) {
        document.getElementById("employeeid").innerHTML = '<h2 style="color:black">Congratulations' + emp.name + '</h3><br><p>Your vehicle company: '
            + veh.company + ' model :' + veh.model + ' number:' + veh.number + ' has been assigned a pass</p>';
